...
Router.run(routes, function (Handler) {
    React.render(React.createElement(Handler, null), document.getElementById('snappass'));
});
...
var Get = React.createClass({displayName: "Get",
    mixins: [Router.State],
    getInitialState: function() {
        return {
            password: ''
...
},{"jquery":3,"react":197,"react-router":28}]},{},[1])
